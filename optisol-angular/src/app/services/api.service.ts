...
export class ApiService {
  ...
  public get(url: string): Observable<User[] | any> {
    const headers = this.customHeader();
    return this.http.get(url, {headers: headers});
  }

  public post(url: string, body: User): Observable<User[] | any>  {
    const headers = this.customHeader();
    return this.http.post(url, body, {headers: headers});
  }

  public put(url: string, body: User): Observable<User[] | any>  {
    const headers = this.customHeader();
    return this.http.put(url, body, {headers: headers});
  }

  public delete(url: string): Observable<User[] | any> {
    const headers = this.customHeader();
